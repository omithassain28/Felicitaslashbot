...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields({
                name: `Links`,
                value: `[**${client.user.username}**](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands) \n [**Support Server**](${supportUrl}) \n [**Vote me**](${voteUrl})`
            })
            .addFields({
        ...
        const row = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder()
                ...
                .setPlaceholder(`${client.user.username} is Love!`)
                .setMaxValues(1)
                .setMinValues(1)
                .setOptions(
